...
class AdeImage
{
  ...
  public function getUrl()
  {
    ...
    return sfConfig::get('app_ade_url')."imageEt?".
      "identifier=".sfConfig::get('app_ade_identifier').
  ...
  public function updateHtml()
  {
    ...
    {
      // "Click" on a branch
      $this->ade_browser->getUrl(sfConfig::get('app_ade_url').'standard/gui/tree.jsp?selectBranchId='.$selectBranchId.'&reset='.$reset.'&forceLoad=false&scroll=0');
      $reset = "false";
    }
    ...
    {
      // "Click" on a group
      $this->ade_browser->getUrl(sfConfig::get('app_ade_url').'standard/gui/tree.jsp?selectId='.$selectId.'&reset='.$reset.'&forceLoad=false&scroll=0');
      $reset = "false";
    }
    ...
    {
      // select weeks
      $this->ade_browser->getUrl(sfConfig::get('app_ade_url').'custom/modules/plannings/info.jsp?order=slot&week='.$i.'&reset='.$reset);
      $reset = "false";
    }
    // Get the page with the link to the image
    $imagemap = $this->ade_browser->getUrl(sfConfig::get('app_ade_url').'custom/modules/plannings/info.jsp?light=true&order=slot');
