...
class updateEsisarIdentifierTask extends updateIdentifierTask
{
  protected function configure()
  {
    ...
    $this->name             = 'identifier-esisar';
    $this->ade_server_name  = 'esisar';
    ...
    $this->urls = array(
      ...
      'standard/gui/tree.jsp?selectBranchId=95&reset=true&forceLoad=false&scroll=0', // "Click" on a group (3A Info S5)
    );
