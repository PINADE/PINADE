...
<?php if($sf_request->getCookie('default') == $filiere.'/'.$promo): ?>
  <?php echo link_to('Supprimer le cookie', "@cookie_reset?filiere=$filiere&promo=$promo&semaine=$semaine") ?>
<?php else: ?>
  <?php echo link_to('Ouvrir cette page au lieu de la page d\'accueil (cookie)', "@cookie_set?filiere=$filiere&promo=$promo&semaine=$semaine") ?><br/>
<?php endif ?>
